...
namespace ires.Infrastructure.Migrations
{
    ...
    [Migration("20251001233425_CreateRoleandPermissionSchema")]
    partial class CreateRoleandPermissionSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.CompanySetting", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long?>("autocashinaccountid_survey")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("autocashinaccountid_survey");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.PermissionGroup", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.PlanPermission", b =>
                {
                    b.Property<int>("PlanId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PlanId", "PermissionGroupId")
                        .HasName("PRIMARY");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.UserPermission", b =>
                {
                    b.Property<long>("EmployeeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.UserRole", b =>
                {
                    b.Property<long>("EmployeeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.CompanySetting", b =>
                {
                    b.HasOne("ires.Infrastructure.Entities.Office", "office")
                        .WithMany()
                        .HasForeignKey("autocashinaccountid_survey");
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.Permission", b =>
                {
                    b.HasOne("ires.Infrastructure.Entities.PermissionGroup", "PermissionGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.RolePermission", b =>
                {
                    b.HasOne("ires.Infrastructure.Entities.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ires.Infrastructure.Entities.Role", "Role")
            ...
            modelBuilder.Entity("ires.Infrastructure.Entities.UserPermission", b =>
                {
                    b.HasOne("ires.Infrastructure.Entities.Employee", "Employee")
