namespace ires.Domain.DTO.Payment
{
    ...
    {
        public PayMongoRequestDto(BillViewModel bill, PayMongoConfig payMongoConfig)
        {
            ...
            attributes.success_url = payMongoConfig.successURL + bill.id.ToString();
            attributes.cancel_url = payMongoConfig.cancelURL;
